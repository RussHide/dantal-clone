...
const Hero = () => {
  return (
    <div className='relative bg-hero bg-cover bg-center bg-no-repeat '>
      ...
      <Navbar />
      <div className=' flex flex-col lg:flex-row justify-center items-center container mx-auto relative z-50 gap-12 py-16 px-10'>
        <div className=' w-full lg:w-1/2'>
          <div className='text-center lg:text-left'>
            <h3 className='text-6xl text-[#142349] font-bold lg:max-w-md'>High Quality and <span className='text-[#4268D2]'>Painless Dentistry</span> </h3>
          ...
          <div className=''>
            <div className='flex flex-col lg:flex-row space-y-4 lg:space-y-0 w-full justify-start items-center'>
