      ...
      <div className="container mx-auto relative z-50 px-10">
        <div className="flex flex-col lg:flex-row justify-center items-center">
          <div className="w-full lg:w-1/2">
            <div className='pl-14 w-full text-center lg:text-left'>
              ...
              <p className='my-5 text-lg lg:max-w-lg '>
                We are a private health care dedicated to providing quality dental care in cosmetic, restorative, and general dentistry.
              </p>
              <button className='bg-[#4268D2] mb-10 lg:mb-0 font-semibold text-white hover:-translate-y-1 transition-transform duration-500 px-10 py-2.5 rounded-[100px]'>Book now</button>
            </div>
          </div>
          <div className="w-full lg:w-1/2 ">
