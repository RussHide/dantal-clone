  ...
  return (
    <div className='container mx-auto mb-24'>
      <div className="flex flex-col lg:flex-row justify-center items-center gap-10">
        ...
        <div className='w-full lg:w-1/2 px-10 lg:px-0 text-center lg:text-left'>
          <div>
          ...
          <div>
            ...
            <div  className='cursor-pointer flex lg:justify-start justify-center items-center w-full text-[#4268D2] font-bold hover:text-[#142349] transition-colors duration-300 '>
              <p>Discover more </p>
